    ...
    <Layout pagename="" prefix={true}>
      <div className="lg:flex justify-between lg:px-16 px-4" data-testid="main">
        <div className="lg:mt-16 mt-8" data-testid="hero-text">
          ...
          <Link to="/social/">
            <button
              className="rounded-none mb-1 text-lg font-semibold border border-indigo-400 bg-indigo-50 text-indigo-500 px-3 py-2 focus:ring-2 ring-offset-2 ring-indigo-400 dark:ring-offset-gray-900 transition-all duration-100 dark:bg-transparent"
        ...
        <div
          className="mx-auto my-12 lg:ml-36 h-1/3 max-w-max flex-shrink-0 shadow-hoverShadow"
