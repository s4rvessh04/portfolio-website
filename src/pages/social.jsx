    ...
    <Layout>
      <div className="lg:flex justify-between lg:px-16 px-4">
        <div className="grid md:grid-cols-2 md:gap-8 gap-4 h-HeightHeroBox my-12 w-full">
          ...
          <div className="flex-shrink-0 z-50 overflow-hidden flex justify-between bg-blue-50">
          ...
          <div className="flex-shrink-0 z-50 overflow-hidden flex justify-between bg-lightBlue-50">
            <si.SiTwitter className="z-0 relative -left-8 -bottom-8 h-48 w-48 flex self-end text-lightBlue-100 dropDown-lightBlue" />
            <h5 className="self-center flex-1 ml-14 font-semibold text-lg text-lightBlue-300">
              Twitter
            </h5>
          </div>
          <div className="flex-shrink-0 z-50 overflow-hidden flex justify-between bg-red-50">
